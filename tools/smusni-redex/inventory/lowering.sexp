(smusni-lowering-manifest
 ...
 (candidate
  ...
  (rules "L5.3")
  (case 1 "ci gerku ce'e re prenu cu nelci" sentence (promised-rows gerku prenu nelci)))
 (candidate
  "samples.md"
  59
 ...
 (candidate
  ...
  (case 2
    ...
    (promised-rows)
    (unresolved
     "Spec L5.28 is a gap; samples §8 labels this term a reference-level comparison, not a standard surface lowering (#9/#20)."))
 ...
 (candidate
  ...
  (rules "L5.2")
  (case 1 "me'i gerku cu blabi" sentence (promised-rows gerku blabi))
  (case 2 "me'i pa gerku cu blabi" sentence (promised-rows gerku blabi))))
