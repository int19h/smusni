(smusni-infer-core-branches
 ...
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper reads the syntactic application head without assigning a type."))
 (helper
  (id "H.argument-fill-counts.3cb95eb94a")
  (function argument-fill-counts)
  (source-lines 717 727)
  (source-sha1 "df1838824e081be32cb0ef8ba897882761fe6b0a")
  (class auxiliary)
  (reason
   "This helper decodes labelled fill syntax before the predicate typing rule applies."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism enforces contravariant parameters and covariant results for function compatibility."))
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper extracts source-located atom syntax without assigning semantic content."))
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper validates and locates the concrete typed-binder separator."))
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper removes the display-only body wrapper before inference."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism distinguishes reference and performance computation result categories for Bind."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism defines which recorded effects make a typing result dynamically impure."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism identifies effectful property arrows that contribute call effects."))
 (helper
  ...
  (class auxiliary)
  (reason
   "This wrapper turns the separately classified compatibility premise into a located diagnostic."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism enforces invariant agreement between restrictor and nuclear property domains."))
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper extends the explicit typing environment with parsed binders."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism recognizes the first-order collection constructors admitted by formation."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism defines the first-order type boundary used by quantifier and collection rules."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism recognizes pure and effectful function types for compatibility."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism adds effectful-call and exporting refer effects to generalized-quantifier results."))
 (helper
 ...
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism selects the literal-zero quantifier rules with distinct export effects."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism unions effects and obligations while constructing the correlated typing record."))
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper parses one concrete typed binder group into environment data."))
 (helper
 ...
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper parses flat concrete type syntax before well-formedness checking."))
 (helper
  ...
  (class auxiliary)
  (reason
   "This helper converts one concrete type node into its structural datum."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism extracts the domain of a Content-valued property or ClauseContent alias."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism enforces L0.1 purity and extracts a unary pure-property domain."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism derives purity from the absence of every dynamic effect class."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism restricts quantifier property domains to first-order or referential types."))
 (helper
  ...
  (class external-gap-or-diagnostic)
  (reason
   "This helper constructs source-located legacy diagnostics and contributes no positive typing conclusion."))
 (helper
  (id "H.row-index-shape.56a3757fc5")
  (function row-index-shape)
  (source-lines 684 715)
  (source-sha1 "7ec14ddc7b64e458fd2607ea8b017ca61ba787d7")
  (class semantic-clause)
  (reason
   "This mechanism derives ordinary arity and event-place availability from a row index."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism requires bidirectional compatibility for invariant property parameters."))
 (helper
 ...
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism stages payload effects while preserving obligations for pure act and sign values."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism defines subsort, computation, reference, and arrow compatibility used by typing premises."))
 (helper
  ...
  (class semantic-clause)
  (reason
   "This mechanism enforces the declared sort and type-former formation rules."))
 (decision
  (id "D.infer-bind.8e1d20fc34")
  (function infer-bind)
  (kind if)
  ...
  (class semantic-clause)
  (reason
   "This arm completes Bind by typing the body under all sequential bindings."))
 (decision
  (id "D.infer-bind.7295ab9792")
  (function infer-bind)
  (kind match)
  (pattern `(Act ,_))
  (ordinal 1)
  ...
  (class semantic-clause)
  (reason
   "This arm recognizes an act-valued body for the performance-to-Discourse coercion."))
 (decision
  (id "D.infer-bind.3edb2ecf9d")
  (function infer-bind)
  (kind match)
  (pattern _)
  (ordinal 1)
  ...
  (class semantic-clause)
  (reason
   "This arm records that a non-Act body does not receive the performance display coercion."))
 (decision
  (id "D.infer-bind.eddf96e776")
  (function infer-bind)
  (kind match)
  (pattern `(PerfComp ,_))
  (ordinal 1)
  ...
  (class semantic-clause)
  (reason
   "This arm admits a performance computation as the body of a performance Bind."))
 (decision
  (id "D.infer-bind.07ad31f753")
  (function infer-bind)
  (kind match)
  (pattern 'Discourse)
  (ordinal 1)
 ...
 (decision
  ...
  (class semantic-clause)
  (reason
   "This arm rejects other result categories after a performance computation."))
 (decision
  (id "D.infer-bind.99e46a5eb5")
  (function infer-bind)
  (kind if)
  ...
  (class semantic-clause)
  (reason
   "This arm assigns Discourse to a performance Bind whose body is an act value."))
 (decision
  (id "D.infer-bind.5317c32aac")
  (function infer-bind)
  (kind if)
  ...
  (class semantic-clause)
  (reason
   "This arm preserves the body's result type when no act display coercion applies."))
 (decision
  (id "D.infer-bind.b53db4f532")
  (function infer-bind)
  (kind if)
  (pattern ((and saw-performance? act-body?) then))
  (ordinal 2)
  ...
  (class semantic-clause)
  (reason
   "This arm records the performance effect introduced by act display coercion."))
 (decision
  (id "D.infer-bind.e1ac6ee521")
  (function infer-bind)
  (kind if)
  (pattern ((and saw-performance? act-body?) else))
  (ordinal 2)
  ...
  (class semantic-clause)
  (reason
   "This arm adds no extra performance effect when display coercion does not apply."))
 (decision
  (id "D.infer-bind.be2f6d40a3")
  (function infer-bind)
  (kind if)
  ...
  (class semantic-clause)
  (reason
   "This arm types the next computation and sequences its binding into the continuation environment."))
 (decision
  (id "D.infer-bind.95d8fedf12")
  (function infer-bind)
  (kind if)
  (pattern
   ((member
     (application-head computation-node)
     '(Context
       Vague
       Refer
       SelectExactly
  ...
  (class auxiliary)
  (reason
   "This arm routes expected-type-directed computation syntax to the checking helper."))
 (decision
  (id "D.infer-bind.9d1420d14b")
  (function infer-bind)
  (kind if)
  (pattern
   ((member
  ...
  (class auxiliary)
  (reason
   "This arm routes synthesizable computation syntax to ordinary inference."))
 (decision
  (id "D.infer-lambda.ecb4c6c30e")
  (function infer-lambda)
  (kind if)
  ...
  (class semantic-clause)
  (reason
   "This arm assigns EFn when the lambda body carries a dynamic effect."))
 (decision
  (id "D.infer-lambda.077cf684d7")
  (function infer-lambda)
  (kind if)
 ...
 (decision
  (id "D.infer-lexical-application.3b6d59ab19")
  (function infer-lexical-application)
  (kind if)
  (pattern
   ((and (core-atom? argument)
  ...
  (class auxiliary)
  (reason
   "This arm includes an ordinary lexical argument in the inferred-argument list."))
 (decision
  (id "D.infer-lexical-application.ecbabdab72")
  (function infer-lexical-application)
  (kind if)
  (pattern
   ((and (core-atom? argument)
 ...
 (decision
  (id "D.infer-lexical-application.f7ce9c6725")
  (function infer-lexical-application)
  (kind if)
  (pattern (event-filled? else))
  (ordinal 1)
  (source-lines 672 672)
  (source-sha1 "b6589fc6ab0dc82cf12099d1c2d40ab994e8410c")
  (class auxiliary)
  (reason
   "This arm leaves the ordinary fill count unchanged when no event label is present."))
 (decision
  (id "D.infer-lexical-application.2684f2a9ef")
  (function infer-lexical-application)
  (kind if)
  ...
  (class auxiliary)
  (reason
   "This arm removes the explicit event value from the ordinary fill count."))
 (decision
  (id "D.infer-lexical-application.424aec251c")
  (function infer-lexical-application)
  (kind if)
  (pattern
   ((and (= ordinary-count (row-decl-total row))
  ...
  (class semantic-clause)
  (reason
   "This arm assigns Content when every ordinary place and required event place are saturated."))
 (decision
  (id "D.infer-lexical-application.51d43c48b0")
  (function infer-lexical-application)
  (kind if)
  (pattern
   ((and (= ordinary-count (row-decl-total row))
  ...
  (ordinal 1)
  (source-lines 681 681)
  (source-sha1 "30722abd9ccf92f4c090ad78da058e486e93ae7f")
  (class semantic-clause)
  (reason
   "This arm preserves a partially filled PredTerm when lexical saturation is incomplete."))
 (decision
  (id "D.infer-quantifier.9c4283c8f5")
  (function infer-quantifier)
  (kind match)
  (pattern `(,arrow ,domains Content))
  (ordinal 1)
  (source-lines 764 770)
  (source-sha1 "d30b8f648a6aeaea37893b9ac66ba07f0887197f")
  (class semantic-clause)
  (reason
   "This arm admits Content-valued Fn or EFn quantifier properties over first-order domains."))
 (decision
  (id "D.infer-quantifier.8c0a082d9c")
  (function infer-quantifier)
  (kind match)
  (pattern other)
  (ordinal 1)
  (source-lines 771 772)
 ...
 (value-helper
  ...
  (class semantic-clause)
  (reason
   "This constant records the projective effect inherited by finite-cardinality consumers."))
 (value-helper
  ...
  (class semantic-clause)
  (reason
   "This constant records the finite-set cardinality definedness obligation."))
 (value-helper
  ...
  (class auxiliary)
  (reason
   "This instrumentation parameter suppresses recursive corpus observations without changing typing."))
 (value-helper
  ...
  (class auxiliary)
  (reason
   "This inert-by-default instrumentation parameter captures external inference roots."))
 (value-helper
  ...
  (class semantic-clause)
  (reason
   "This constant supplies the declared default subsort edges used by compatibility."))
 (value-helper
 ...
 (branch
  ...
  (class semantic-clause)
  (reason
   "E01 implements the adopted typed closure, pure Only or numeric comparison signature; the corresponding named Redex clause is executable."))
 (branch
  (id "B.infer-application.5aa652d101")
  (function infer-application)
  (pattern (eq? head 'Only))
  (source-lines 1105 1115)
  (source-sha1 "9ddd13a76c1db7f438e70c79340226b43b5da009")
  (class semantic-clause)
  (reason
   "E01 implements the adopted typed closure, pure Only or numeric comparison signature; the corresponding named Redex clause is executable."))
 (branch
  (id "B.infer-application.6e12ec0ba8")
  (function infer-application)
  (pattern
   (member
    head
    '(IndividualSome IndividualNo IndividualEvery PluralSome PluralNo)))
  (source-lines 1116 1135)
