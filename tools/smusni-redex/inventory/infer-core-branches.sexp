(smusni-infer-core-branches
 ...
 (branch
  ...
  (class auxiliary)
  (reason
   "This branch dispatches direct binders, including PerformSource, to their separately classified typing rules."))
 (branch
 ...
 (decision
  (id "D.infer-perform-source.3be6e5e704")
  (function infer-perform-source)
  (kind if)
  ...
  (class auxiliary)
  (reason
   "F01 normalizes the documented omitted-Host shorthand without evaluating a role operand."))
 (decision
  (id "D.infer-perform-source.f87a6a2a34")
  (function infer-perform-source)
  (kind if)
  ...
  (reason
   "F01 normalizes the documented omitted-Host shorthand without evaluating a role operand."))
 (decision
  (id "D.infer-perform-source.007e96df56")
  (function infer-perform-source)
  (kind match)
 ...
 (decision
  (id "D.infer-perform-source.ff5d856d02")
  (function infer-perform-source)
  (kind match)
  (pattern _)
  (ordinal 1)
