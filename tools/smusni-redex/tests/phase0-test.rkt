...
(check-equal? (length live-branches) 95)
(check-equal? (length branch-ledger) 95)
(check-equal? (length live-helpers) 38)
(check-equal? (length helper-ledger) 38)
(check-equal? (length live-decisions) 27)
(check-equal? (length decision-ledger) 27)
