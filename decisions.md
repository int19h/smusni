...
## The genuine open remainder

These are different kinds of remaining work; “supported meaning, missing
interface” is not the same as “which meaning should the language select?”
...
| Q11 | mintu/mi'u and simsa/si'a viable; frica/jmina plausible adaptations; nonassertive mi'unai attested | Exact lexical rows/target adaptation/standard domain/sharing/nai scope; explicit, recovered, shared-existential and per-comparison standards remain distinct | #14, #87 |
...
| C08 | Withdraw inadequate Only/Additive surface formulas; same-level alternatives and own-subpart requirement recorded, Q10. |
| C09 | Share formed frames/sites rather than copied source; dependencies remain explicit. |
| C10 | Approximate equality/cardinal adequacy debt, Q08, including attested du examples. |
...
| C24 | CoRef congruence/actual carrier clarified; full discipline D remains unadopted. |
| C25 | Human-adopted persistence under na applied and divergence explained. |
| C26 | Zero distinguished per threshold kind; exact no'e evidence narrows Q07 without selecting width representation. #69 already resolved AtLeast formation. |
